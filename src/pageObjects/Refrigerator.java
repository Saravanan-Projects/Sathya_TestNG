...
/*
 *This Class has all the page objects in Refrigerator module
 *and implements Commodity interface
 *
 *@author Saravanan, Arumugam
 */
public class Refrigerator implements Commodity {
	...
	//"elements"  is an instance for list of webelements in Refrigerator module.
	@FindBys(@FindBy(xpath = "//h3/a/span")) public List<WebElement> elements;
	
	/*
	 * The constructor  "Refrigerator" does initialize the webdriver and
	 * action class objects, initialize the PageFactory for Refrigerator
	 * module web page
	 * 
	 * @param driver - Receives webdriver object
	 */
	public Refrigerator(WebDriver driver) {
		this.driver = driver;
	 ...
	 * at the Refrigerator module web page
	 * 
	 * (non-Javadoc)
	 ...
	 * web elements in Refrigerator module web page
	 * 
	 * @return elements - list of web elements in Refrigerator module web page
	 * (non-Javadoc)
	...
	/*
	 * Returns total number of webelements in Refrigerator Module
	 * 
	...
	/*
	 * Clicks the each Refrigerator Product by using it's xpath and returns
	 * false if webelement of specific Refrigerator Product is clicked else
