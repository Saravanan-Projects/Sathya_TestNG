...
/*
 *This Class has all the page objects in Air Conditioner module
 *and implements Commodity interface
 *
 *@author Saravanan, Arumugam
 */
public class AirConditioner implements Commodity {
	...
	//"elements"  is an instance for list of webelements in Air Conditioner module.
	@FindBys(@FindBy(xpath = "//h3/a/span")) public List<WebElement> elements;
	
	/*
	 * The constructor  "AirConditioner" does initialize the webdriver and
	 ...
	 * at the Air Conditioner module web page
	 * 
	 * (non-Javadoc)
	 ...
	 * web elements in Air Conditioner module web page
	 * 
	 * @return elements - list of web elements in Air Conditioner module web page
	 * (non-Javadoc)
	...
	/*
	 * Returns total number of webelements in Air Conditioner Module
	 * 
	 ...
	 * false if webelement of specific Air Conditioner Product is clicked else
	...
	public boolean eachProduct(int i) {
		...
		try {
			...
			System.out.println("Air Conditioner Product Skipped");
			return true;
		}
		return false;
	}
